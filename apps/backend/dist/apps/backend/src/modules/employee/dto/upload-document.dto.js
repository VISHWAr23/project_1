...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Type of Document (e.g. Aadhaar Card, PAN Card, Passbook)' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Public Storage / File Download URL' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], UploadDocumentDto.prototype, "fileUrl", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Storage path inside Supabase bucket' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], UploadDocumentDto.prototype, "storagePath", void 0);
