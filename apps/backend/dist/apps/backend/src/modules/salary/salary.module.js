...
exports.SalaryModule = SalaryModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [salary_service_1.SalaryService, payroll_engine_service_1.PayrollEngineService],
        exports: [salary_service_1.SalaryService, payroll_engine_service_1.PayrollEngineService],
    })
], SalaryModule);
