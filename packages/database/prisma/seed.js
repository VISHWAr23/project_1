...
function getPastDate(daysAgo, hour = 9, minute = 0) {
    ...
    for (const rm of rawMaterialsData) {
        ...
        await prisma.inventoryTransaction.create({
            data: {
                ...
                transactionType: client_1.TransactionType.PURCHASE_RECEIPT,
                quantity: rm.stock,
                previousStock: 0,
                newStock: rm.stock,
    ...
    for (const fp of finishedProductsCatalog) {
        ...
        await prisma.inventoryTransaction.create({
            data: {
                ...
                transactionType: client_1.TransactionType.ADJUSTMENT_ADD,
                quantity: fp.stock,
                previousStock: 0,
                newStock: fp.stock,
    ...
    const jobWorkOrdersData = [
        {
            ...
            status: client_1.JobWorkStatus.COMPLETED,
            daysAgo: 14,
            issuedWeight: 1200.0,
            issuedQty: 24,
        ...
        },
        {
            ...
            status: client_1.JobWorkStatus.PARTIAL_RETURN,
            daysAgo: 5,
            issuedWeight: 1500.0,
            issuedQty: 30,
        ...
        },
        {
            ...
            status: client_1.JobWorkStatus.MATERIALS_ISSUED,
            daysAgo: 2,
            issuedWeight: 850.0,
            issuedQty: 17,
            returnedWeight: 0.0,
        ...
        },
        {
            ...
            status: client_1.JobWorkStatus.CREATED,
            daysAgo: 0,
            issuedWeight: 1000.0,
            issuedQty: 20,
            returnedWeight: 0.0,
            ...
            data: {
                ...
                statusHistory: {
                    create: [
                        {
                            fromStatus: null,
                            toStatus: client_1.JobWorkStatus.CREATED,
                            notes: 'Job work order registered and approved by Job Work Manager',
                            createdAt: getPastDate(jw.daysAgo),
                        },
                        ...(jw.status !== client_1.JobWorkStatus.CREATED ? [{
                                fromStatus: client_1.JobWorkStatus.CREATED,
                                toStatus: jw.status,
        ...
        if (jw.challanNumber) {
            await prisma.jobWorkChallan.create({
                data: {
                    ...
                    status: jw.status === client_1.JobWorkStatus.COMPLETED ? 'COMPLETED' : 'DISPATCHED',
                    jobWorkCompanyId: jw.companyId,
                    rawMaterialId: jw.rawMatId,
                },
            });
    ...
    const serializedRolls = [
        {
            ...
            stage: client_1.RollStage.GREY_FABRIC_ROLL,
            status: client_1.RollStatus.CONVERTED,
            weight: 48.5,
            width: 48,
            length: 500,
            gsm: 28.0,
        ...
        },
        {
            ...
            stage: client_1.RollStage.BLEACHED_GAUZE_ROLL,
            status: client_1.RollStatus.QC_APPROVED,
            weight: 44.2,
            width: 48,
            length: 480,
            gsm: 28.5,
        ...
        },
        {
            ...
            stage: client_1.RollStage.SLIT_ROLL,
            status: client_1.RollStatus.IN_PRODUCTION,
            weight: 52.0,
            width: 60,
            length: 650,
            gsm: 45.0,
        ...
        },
        {
            ...
            stage: client_1.RollStage.FINISHED_PRODUCT_ROLL,
            status: client_1.RollStatus.PACKED,
            weight: 32.0,
            width: 36,
            length: 350,
            gsm: 50.0,
        ...
        },
        {
            ...
            stage: client_1.RollStage.RAW_COTTON_BALE,
            status: client_1.RollStatus.STORED_IN_RM,
            weight: 165.0,
            width: 0,
            length: 0,
            gsm: 0,
    ...
    for (const r of serializedRolls) {
        await prisma.cottonRoll.create({
            data: {
                ...
                currentLocation: r.status === client_1.RollStatus.STORED_IN_RM ? 'Raw Cotton Bay A' : 'Production Floor Area 1',
                createdAt: getPastDate(r.daysAgo),
                statusHistory: {
                    create: [
                        {
                            fromStatus: null,
                            toStatus: client_1.RollStatus.RAW_RECEIVED,
                        ...
                        {
                            fromStatus: client_1.RollStatus.RAW_RECEIVED,
                            toStatus: r.status,
                ...
                qcInspections: {
                    create: {
                        ...
                        testedpH: 6.8,
                        moistureContent: 5.2,
                        resultStatus: client_1.QCResultStatus.PASSED,
    ...
    const productionBatchesData = [
        {
            ...
            planned: 5000,
            completed: 5000,
            status: client_1.ProductionWorkOrderStatus.COMPLETED,
            daysAgo: 13,
        },
        {
            num: 'PB-2026-0802',
        ...
        },
        {
            ...
            planned: 4000,
            completed: 2800,
            status: client_1.ProductionWorkOrderStatus.IN_PROGRESS,
            daysAgo: 4,
        },
        {
            num: 'PB-2026-0805',
        ...
        },
        {
            ...
            planned: 1200,
            completed: 0,
            status: client_1.ProductionWorkOrderStatus.PLANNED,
            daysAgo: 1,
        },
    ];
    for (const pb of productionBatchesData) {
        await prisma.productionBatch.create({
            data: {
                ...
                endDate: pb.status === client_1.ProductionWorkOrderStatus.COMPLETED ? getPastDate(pb.daysAgo - 2) : null,
